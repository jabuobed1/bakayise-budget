...
function BakayiseAppContent() {
  ...
  const handleExecuteDeposit = async (depositData: {
    ...
    const depositTransferId = `transfer_atmdep_${timestamp}_${Math.random().toString(36).substring(2, 7)}`;
    ...
    const depositIncome: Income = {
      ...
      receivedDate: dateStr,
      accountId: destAcc.id,
      sourceAccountId: depositData.sourceType === 'cash_wallet' ? depositData.cashAccountId : undefined,
      targetAccountId: destAcc.id,
      transferType: 'internal_transfer',
