      ...
      <div className="flex items-center justify-between gap-3 pb-3 border-b border-white/[0.08]">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="text-sm sm:text-base font-bold text-white tracking-tight flex items-center gap-2">
              <span className="truncate">Income Streams</span>
            </h3>
            <div className="text-[11px] text-slate-400 font-mono">
              <span className="text-[#30D158] font-bold">{formatZAR(totalReceived)}</span>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="flex items-center justify-center p-2 sm:px-3 sm:py-1.5 rounded-[12px] bg-[#30D158] hover:bg-[#34C759] text-black text-xs font-bold transition active:scale-95 cursor-pointer whitespace-nowrap shrink-0"
            title="Add Income"
          >
            <Plus className="w-4 h-4 sm:w-3.5 sm:h-3.5" strokeWidth={2.8} />
            <span className="hidden sm:inline ml-1.5">Add Income</span>
          </button>
          
          <button
            onClick={() => setIsCollapsed(!isCollapsed)}
            className="flex items-center justify-center w-8 h-8 rounded-[10px] bg-[#2C2C2E] hover:bg-[#3A3A3C] text-slate-400 hover:text-white border border-white/10 transition cursor-pointer"
          >
